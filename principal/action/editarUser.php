<?php
    ...
    if (isset($_SESSION['id_usuario'])) {
		...
		$codigo_sql = "SELECT * FROM $tabelaUsuario WHERE id_usuario = '$id_usuario'";
...
<body>
    <div class="pag-width">
        ...
        <form class="text-bg-dark position-absolute rounded-3 mx-auto p-4 d-flex flex-column justify-content-around" action=""
            ...
            <div class="link mt-2 d-flex align-items-center justify-content-start">
            	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
			        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
		    	</svg>
                <a href="../indexPrincipal.php" class="ms-1" style="font-size: .85em; color: rgba(255, 255, 255, .8);">Voltar</a>
            </div>
        </form>
    </div>
